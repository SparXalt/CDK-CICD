...
class PipelineCdkStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, ecr_repository, test_app_fargate, **kwargs) -> None:
        ...
        ssmParameter = ssm.StringParameter(
            ...
            string_value='arn:aws:signer:us-east-2:318867948253:/signing-profiles/ecr_signing_profile',
        )
        ...
        source_action = codepipeline_actions.CodeStarConnectionsSourceAction(
            ...
            connection_arn = "arn:aws:codeconnections:us-east-2:318867948253:connection/1cceacec-3dad-4e79-a2c2-c72f6e89e948"
        )
